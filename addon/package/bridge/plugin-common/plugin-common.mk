...
THUNDER_COBALT_USER_GROUP=$(subst ",,$(BR2_PACKAGE_PLUGIN_COBALT_GROUP)")
endif
ifneq ($(BR2_PACKAGE_THUNDER_CDMI_GROUP),"")
THUNDER_CDMI_GROUP=,$(subst ",,$(BR2_PACKAGE_THUNDER_CDMI_GROUP)")
endif
THUNDER_COBALT_USER=$(subst ",,$(BR2_PACKAGE_PLUGIN_COBALT_USER)") -1 $(THUNDER_COBALT_USER_GROUP) -1 * - - $(subst ",,$(BR2_PACKAGE_THUNDER_PLATFORM_VIDEO_DEVICE_GROUP)"),$(subst ",,$(BR2_PACKAGE_THUNDER_GROUP)")$(THUNDER_CDMI_GROUP) cobalt
...
PLUGIN_COMMON_CONF_OPTS += -DPLUGIN_COBALT_GROUP=$(THUNDER_COBALT_USER_GROUP)
endif
