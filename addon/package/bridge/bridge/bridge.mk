...
ifeq ($(BR2_PACKAGE_BRIDGE_SECURE_SOCKETS),y)
BRIDGE_CONF_OPTS += -DSECURE_SOCKET=ON
endif

ifneq ($(BR2_PACKAGE_BRIDGE_DISCOVERY),)
BRIDGE_CONF_OPTS += -DBRIDGE_DISCOVERY_BINDING="$(call qstrip,$(BR2_PACKAGE_BRIDGE_DISCOVERY_BINDING))"
BRIDGE_CONF_OPTS += -DBRIDGE_DISCOVERY_TTL="$(call qstrip,$(BR2_PACKAGE_BRIDGE_DISCOVERY_TTL))"
endif
...
ifeq ($(BR2_PACKAGE_BRIDGE_NETWORKING),y)
    ...
    BRIDGE_DEPENDENCIES += libmnl
endif

ifeq ($(BR2_PACKAGE_BRIDGE_LIBUSB),y)
