...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_DISPLAYINFO)$(BR2_PACKAGE_BRIDGE_DISPLAYINFO),"")
    NETFLIX52_CONF_OPTS += -DGIBBON_PLATFORM=posix 
    ifeq ($(BR2_PACKAGE_BRIDGE_DISPLAYINFO),y)
        NETFLIX52_CONF_OPTS += -DGIBBON_GRAPHICS=bridge
        NETFLIX52_CONF_OPTS += -DGIBBON_INPUT=bridge

        NETFLIX52_DEPENDENCIES += bridge-clients
    else
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PROVISIONPROXY)$(BR2_PACKAGE_BRIDGE_PROVISIONPROXY),"")
